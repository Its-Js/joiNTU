...
public class avatar extends AppCompatActivity {
    ...
    private void SendUserToMainActivity() {
        ...
        int avatarID = 2131165335 + num; // gee_me_001 has an id of 2131230842, 002 has id of 2131230843 so on and so forth. num is w.r.t to grid position +2
        ...
        StorageRef.child(key).putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        UsersRef.child("AvatarID").setValue(stringAvatarID);
                        UsersRef.child("AvatarUrl").setValue(downloadUrl.toString());
